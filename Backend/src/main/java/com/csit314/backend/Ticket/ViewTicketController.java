...
public class ViewTicketController {
    ...
    public ResponseEntity<ArrayList<Ticket>> getAllTickets() throws SQLException {
        Ticket t = new Ticket();
        ArrayList<Ticket> tickets = t.listAll();
     ...
     * public ResponseEntity<ArrayList<Ticket>>
     * getAllTicketsByMovieSessionId(@PathVariable Integer movieSessionId)
     * throws SQLException {
     ...
     * public ResponseEntity<ArrayList<Ticket>> getAllTicketsBySeatId(@PathVariable
     * Integer seatId) throws SQLException {
     ...
     * public ResponseEntity<ArrayList<Ticket>>
     * getAllTicketsByUserAccountId(@PathVariable Integer userAccountId)
     * throws SQLException {
