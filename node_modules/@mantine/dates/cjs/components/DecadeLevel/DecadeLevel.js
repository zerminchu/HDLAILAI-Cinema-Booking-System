...
var DecadeLevel_styles = require('./DecadeLevel.styles.js');
...
const DecadeLevel = React.forwardRef((props, ref) => {
  const _a = core.useComponentDefaultProps("DecadeLevel", defaultProps, props), {
    decade,
    locale,
    minDate,
    maxDate,
  ...
  const { classes, cx } = DecadeLevel_styles['default'](null, {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, __spreadValues({
    ...
    withNext,
    withPrevious
  }, stylesApiProps)), /* @__PURE__ */ React__default.createElement(YearsList.YearsList, __spreadValues({
    decade,
    locale,
    minDate,
    maxDate,
