...
import FnbPurchaseSummary from "../pages/Customer/FnbPurchaseSummary";
import FnbPurchaseReceipt from "../pages/Customer/FnbPurchaseReceipt";
  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route path="/FnbPurchaseSummary" element={<FnbPurchaseSummary />} />
